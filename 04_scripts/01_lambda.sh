#!/bin/bash
  ...
  echo "cp ../../../../02_tmp/$SER/$PRO/01_variables.tf ." >> platf04/01_infra/$SER/$PRO/$NAM/scripts/script.sh
  echo "cp ../../../../02_tmp/$SER/$PRO/03_main.tf" . >> platf04/01_infra/$SER/$PRO/$NAM/scripts/script.sh
  echo "cp ../../../../03_pro/$PRO/02_provider.tf" . >> platf04/01_infra/$SER/$PRO/$NAM/scripts/script.sh
